...
class ListDonorsUseCase:
    ...
    async def execute(
        ...
        self.logger.info(
            "Donors listed", extra={"count": len(items), "total": total, "page": page}
        )
